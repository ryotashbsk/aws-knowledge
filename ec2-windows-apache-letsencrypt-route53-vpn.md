...
- [1. SSLの発行方法](#issue-certificate)
- [2. SSLの自動更新方法](#auto-renewal)
- [3. HTTPSリダイレクト設定](#https-redirect)
...
Route 53 を使った DNS-01 認証には、win-acme の **pluggable版** を使用する。Route 53 DNS validation plugin は別途ダウンロードし、`wacs.exe` と同じフォルダに展開する。
